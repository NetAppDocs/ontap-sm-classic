...
[.lead]
If you encounter any issues when using ONTAP System Manager classic (available in 9.7 and earlier), you can send the log files to technical support to help troubleshoot the issues. The System Manager log files are located in the `mlog` directory along with the ONTAP log files.
