...
[.lead]
You can configure the NVMe protocol on a storage virtual machine (SVM) using System Manager classic (available in ONTAP 9.7 and earlier). You can then create namespaces and assign them to an NVMe subsystem and host.
