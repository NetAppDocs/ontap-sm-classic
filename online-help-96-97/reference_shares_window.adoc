...
+
Displays whether the share is enabled for continuous availability. Beginning with System Manager 9.6, continuous availability is supported for FlexGroup volumes.
 ...
 ** Continuously Available Share
+
Specifies whether the share is enabled or disabled for continuous availability. Beginning with System Manager 9.6, continuous availability is supported for FlexGroup volumes.
